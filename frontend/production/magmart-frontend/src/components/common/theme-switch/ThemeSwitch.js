...
function MUISwitch(props) {
  ...
  const handleChange = ()=> {
    props.changer.changeTheme();
  }

  return (
    <SwitchRoot onClick={handleChange} className={clsx(stateClasses)}>
      <SwitchTrack>
...
const ThemeSwitch = function UseSwitchesCustom(props) {
    return <MUISwitch changer={props} />;
}
